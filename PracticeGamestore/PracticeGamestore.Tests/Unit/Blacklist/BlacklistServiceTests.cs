...
public class BlacklistServiceTests
{
    ...
    public async Task GetAllAsync_ReturnsAllBlacklists()
    {
        ...
        {
            new() {Id = Guid.NewGuid(), UserEmail = "user@example.com", CountryId = Guid.NewGuid()},
            new() {Id = Guid.NewGuid(), UserEmail = "user2@example.com", CountryId = Guid.NewGuid()},
        };
    ...
    {
        //Arrange
        var entity = new DataAccess.Entities.Blacklist { Id = Guid.NewGuid(), UserEmail = "emaple@emaple.com", CountryId = Guid.NewGuid() };
    ...
    {
        //Arrange
        var dto = new BlacklistDto(Guid.NewGuid(), "user@emaple.com", Guid.NewGuid());
    ...
    {
        //Arrange
        var dto = new BlacklistDto(Guid.NewGuid(), "user@exaple.com", Guid.NewGuid());
    ...
    {
        //Arrange
        var dto = new BlacklistDto(Guid.NewGuid(), "Action");
